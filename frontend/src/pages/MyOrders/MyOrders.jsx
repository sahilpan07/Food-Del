                ...
                <div className="space-y-8">
                    {data.map((order, index) => (
                        <div key={index} className=" bg-white p-6 rounded-xl shadow-lg hover:shadow-2xl transition duration-300 ease-in-out">
                            ...
                            <div className="mt-6">
                                <p className="text-xl text-gray-900 font-semibold">Rs {order.amount}.00</p>
                                <p className="text-sm text-gray-500 flex items-center mt-2">
                                    <span className="text-green-500 text-lg">&#x25cf;</span> <b className="ml-1 text-gray-800">{order.status}</b>
                                </p>
                            </div>
                            <div className="mt-6 flex justify-between items-center">
                                <button onClick={fetchOrders} className="bg-blue-600 text-white py-2 px-6 rounded-full hover:bg-blue-700 transition duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500">
                                    Track Order
                                </button>
