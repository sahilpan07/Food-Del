...
const ContactUs = () => {
  ...
  const socialIcons = [
    { icon: "uil:facebook", label: "Facebook", hoverColor: "hover:text-blue-600" },
    { icon: "mdi:instagram", label: "Instagram", hoverColor: "hover:text-pink-500" },
    { icon: "prime:twitter", label: "Twitter", hoverColor: "hover:text-blue-600" },
    { icon: "mingcute:youtube-fill", label: "YouTube", hoverColor: "hover:text-red-600" },
  ];
      ...
      <div className="flex flex-col gap-8 w-full p-6 bg-white rounded-lg shadow-xl md:p-8 ">
        ...
        <div className="text-center mb-6">
          ...
          <div className="mt-4 text-gray-600">
            <p>If you have any questions, feel free to drop us a message. Our team will get back to you shortly.</p>
            <p>We value your feedback and strive to improve our services with your help.</p>
          </div>
        </div>
        ...
        <div className="flex flex-col lg:flex-row justify-between gap-10">
          <div className="flex flex-col h-auto w-full gap-6 bg-[#040A27] rounded-lg text-white p-6 shadow-lg">
            <div className="flex flex-col gap-4 items-center">
              ...
              <p className="text-sm text-gray-300">Say something to start live chat</p>
            </div>
            <div className="flex flex-col gap-6">
              <div className="flex flex-col items-center gap-4">
                <Icon icon="line-md:phone-call" className="text-2xl hover:text-gray-200 transition-all duration-300" />
                <p className="text-sm">+977 9876464732</p>
              </div>
              <div className="flex flex-col items-center gap-4">
                <Icon icon="material-symbols:mail" className="text-2xl hover:text-gray-200 transition-all duration-300" />
                <p className="text-sm">info@yourdomain.com</p>
              </div>
              <div className="flex flex-col items-center gap-4">
                <Icon icon="gridicons:location" className="text-2xl hover:text-gray-200 transition-all duration-300" />
                ...
                <Form className="mt-6">
                  <div className="flex flex-col md:flex-row md:justify-between md:gap-4">
                    <div className="mb-6 w-full">
                      ...
                      />
                      <ErrorMessage name="first_name" component="div" className="mt-1 text-red-600" />
                    </div>
                    <div className="mb-6 w-full">
                      ...
                      <Field
                        ...
                        className="w-full p-4 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all"
                      />
                      <ErrorMessage name="last_name" component="div" className="mt-1 text-red-600" />
                    </div>
                  </div>

                  <div className="mb-6">
                    <label htmlFor="contact_email" className="block text-gray-700 text-lg font-medium">Email</label>
                    <Field
                      type="email"
                      name="contact_email"
                      className="w-full p-4 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all"
                    />
                    <ErrorMessage name="contact_email" component="div" className="mt-1 text-red-600" />
                  </div>

                  <div className="flex flex-col md:flex-row md:justify-between md:gap-4">
                    <div className="mb-6 w-full">
                      <label htmlFor="phone" className="block text-gray-700 text-lg font-medium">Phone no.</label>
                      <Field
                        type="tel"
                        name="phone"
                        className="w-full p-4 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all"
                      />
                      <ErrorMessage name="phone" component="div" className="mt-1 text-red-600" />
                    </div>
                    <div className="mb-6 w-full">
                      <label htmlFor="address" className="block text-gray-700 text-lg font-medium">Address</label>
                      <Field
                        type="text"
                        name="address"
                        className="w-full p-4 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all"
                      />
                      <ErrorMessage name="address" component="div" className="mt-1 text-red-600" />
                    </div>
                  </div>

                  <div className="mb-6">
                    <label className="block text-gray-700 text-lg font-medium">Subject</label>
                    ...
                    <ErrorMessage name="subject" component="div" className="mt-1 text-red-600" />
                  </div>
                  ...
                  <div className="mb-6">
                    ...
                    <Field
                      ...
                      className="w-full p-4 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all"
                    />
                    <ErrorMessage name="message" component="div" className="mt-1 text-red-600" />
                  </div>
