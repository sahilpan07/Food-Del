  ...
  const faqs = [
    {
      ...
      answer:
        "To place an order, simply browse our menu, select your items, and proceed to checkout.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "If your order is late, please contact our support team for assistance.",
    },
  ];
  ...
  return (
    <div className="flex mt-10 lg:gap-10 bg-white rounded-lg p-10 items-center justify-center mx-12 md:mx-20">
      <div className="w-full ">
        <h2 className=" text-md font-bold mb-4 lg:text-xl">
