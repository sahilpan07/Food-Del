        ...
        >
          {categories.map((item, index) => (
            <div
              ...
              className={`flex flex-col items-center cursor-pointer transition-transform duration-300 ease-in-out hover:scale-105 ${
            ...
            >
              ...
              >
                ...
                />
                <div
                  className={`absolute top-0 left-0 w-full h-full bg-black opacity-20 rounded-full transition-all duration-300 ${
                    category === item.name ? "opacity-40" : ""
                  }`}
                ></div>
              </div>
