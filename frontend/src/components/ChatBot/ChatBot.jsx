  ...
  return (
    <div className="relative z-50">
      <button
        ...
        className="fixed bottom-6 right-6 bg-gradient-to-r from-blue-500 to-purple-600 text-white rounded-full p-3 shadow-xl transform hover:scale-110 transition-all duration-300 ease-in-out hover:shadow-2xl"
      >
